...
// UserGetterMock is a mock implementation of usecases.UserGetter.
//
//	func TestSomethingThatUsesUserGetter(t *testing.T) {
//
//		// make and configure a mocked usecases.UserGetter
...
//		}
//
//		// use mockedUserGetter in code that requires usecases.UserGetter
...
// UserAdderMock is a mock implementation of usecases.UserAdder.
//
//	func TestSomethingThatUsesUserAdder(t *testing.T) {
//
//		// make and configure a mocked usecases.UserAdder
...
//		}
//
//		// use mockedUserAdder in code that requires usecases.UserAdder
//		// and then make assertions.
//
//	}
...
// TaskListerMock is a mock implementation of usecases.TaskLister.
//
//	func TestSomethingThatUsesTaskLister(t *testing.T) {
//
//		// make and configure a mocked usecases.TaskLister
...
//		}
//
//		// use mockedTaskLister in code that requires usecases.TaskLister
//		// and then make assertions.
//
//	}
...
// TaskAdderMock is a mock implementation of usecases.TaskAdder.
//
//	func TestSomethingThatUsesTaskAdder(t *testing.T) {
//
//		// make and configure a mocked usecases.TaskAdder
...
//		}
//
//		// use mockedTaskAdder in code that requires usecases.TaskAdder
//		// and then make assertions.
//
//	}
...
// TokenGeneratorMock is a mock implementation of usecases.TokenGenerator.
//
//	func TestSomethingThatUsesTokenGenerator(t *testing.T) {
//
//		// make and configure a mocked usecases.TokenGenerator
...
//		}
//
//		// use mockedTokenGenerator in code that requires usecases.TokenGenerator
//		// and then make assertions.
//
//	}
...
// UserNameGetterMock is a mock implementation of usecases.UserNameGetter.
//
//	func TestSomethingThatUsesUserNameGetter(t *testing.T) {
//
//		// make and configure a mocked usecases.UserNameGetter
...
//		}
//
//		// use mockedUserNameGetter in code that requires usecases.UserNameGetter
//		// and then make assertions.
//
//	}
